...
INSERT INTO `empleados` VALUES (1,'MARILIN','QUISPE',NULL,NULL,NULL,NULL,1,1);
...
CREATE TABLE `usuarios_rol` (
  `ID_USUARIOS_ROL` int NOT NULL AUTO_INCREMENT,
  `ID_USUARIOS` int DEFAULT NULL,
  `ID_ROL` int DEFAULT NULL,
  PRIMARY KEY (`ID_USUARIOS_ROL`),
  UNIQUE KEY `XPKROL` (`ID_USUARIOS_ROL`),
  KEY `ID_USUARIOS` (`ID_USUARIOS`),
  KEY `ID_ROL` (`ID_ROL`),
  CONSTRAINT `usuarios_rol_ibfk_1` FOREIGN KEY (`ID_USUARIOS`) REFERENCES `usuarios` (`ID_USUARIOS`),
  CONSTRAINT `usuarios_rol_ibfk_2` FOREIGN KEY (`ID_ROL`) REFERENCES `rol` (`ID_ROL`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-12-17 20:07:43
