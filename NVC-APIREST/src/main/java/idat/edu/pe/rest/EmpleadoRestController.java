...
public class EmpleadoRestController {
	...
	@GetMapping(value = "/empleados/{id}", produces = { MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_XML_VALUE })
	@ResponseBody
	...
	@PutMapping(value = "/empleados/{id}", produces = { MediaType.APPLICATION_JSON_VALUE,
